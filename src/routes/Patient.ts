...
export default function (App: Express) {
	 ...
	 */
	App.post('/api/patient', Patient.get)
	 ...
	 *                    Pesca: 0
	 */
	App.post('/api/addPatient', Patient.addPatient)
	App.post('/api/archive', Patient.archive)
	App.post('/api/updatePatient', Patient.updatePatient)
	...
	App.post('/api/desvincularEvincular', Patient.desvincularEvincular)
}
